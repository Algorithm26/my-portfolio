    ...
    <div className="container max-w-7xl mx-auto py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="space-y-8">
          ...
          ideas, or opportunities to be part of visions.</p>
          <div>
            <div className="flex items-center gap-4">
              <FaEnvelope className="w-6 h-6 text-primary"/>
              <div>
                <h3 className="text-semibold">Email</h3>
                <Link href="mailto:supphakrit.tho@gmail.com" className="text-secondary 
                hover:text-primary">supphakrit.tho@gmail.com</Link>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <Link href="tel:+66867251234" className="text-secondary 
                hover:text-primary">(+66) 867251234</Link>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-secondary">Bangkok, Thailand</p>
              </div>
            </div>
