                ...
                <div className='hidden md:flex items-center space-x-8'>
                    {
                        menuItems.map((item) => {
                            ...
                            return (
                                ...
                                transition-colors ${isActive ? 'font-medium text-primary' : ''}`}>
                                    {item.label}
                                </Link>
                            );
                        })
                    }
                    <button onClick={toggleTheme} className='p-2 rounded-lg hover:bg-gray-100 dark:text-white 
                    hover:text-primary dark:hover:bg-gray-800 transition-colors cursor-pointer'>
                        {
                            theme === "dark" ? (
                ...
                isMobileMenuOpen && (
                    <div className='md:hidden'>
                        <div className='py-4 space-y-4'>
                            ...
                            <div>
                                <button onClick={toggleTheme} className='flex items-center py-2 hover:text-primary trainsition-colors'>
                                    {
                                        theme === "dark" ? (
